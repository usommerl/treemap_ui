...
class Squarified extends RowBasedLayoutAlgorithms {
  ...
  void _layoutRow(BranchNode parent, List<DataModel> rowModels, Orientation orientation) {
    ...
    final row = orientation.isHorizontal ?
        new LayoutHelper.alwaysFloatLeft(availableWidthPercentage, percentageRowItems.of(availableHeightPercentage), parent, orientation):
        new LayoutHelper.alwaysFloatLeft(percentageRowItems.of(availableWidthPercentage), availableHeightPercentage, parent, orientation);
